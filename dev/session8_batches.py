"""
Session 8 wave-builder — classify newly-bridged web_extracts.

The Session 8 resolver fix (mn_loose / mn_loose_xmarket) bridged 18 more
scrape slugs into known base_keys. Re-running write_web_extracts.py produced
those JSONs. This script dedups against data/classified/ and emits batches
of up to BATCH_SIZE.

Sub-agents will write to data/classified_8/<base_key>.json (NOT classified/).
...
OUT_DIR = PROJECT_ROOT / 'dev' / '_session8_batches'
