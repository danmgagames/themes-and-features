"""
Session 8 validation gate.

Checks the 17 web-sourced classified JSONs in data/classified_8/ for:
...
5. base_key uniqueness within classified_8/
6. base_key non-collision with already-classified data/classified/
   (intentional — Session 8 targets ONLY base_keys not yet in classified/)
...
NEW_DIR = PROJECT_ROOT / 'data' / 'classified_8'
...
def main():
    failures: list[str] = []
    print('=' * 60)
    print('Session 8 — validation gate')
    print('=' * 60)
    ...
    print(f'\n[5] base_key uniqueness in classified_8/: {len(bks)} files, {len(set(bks))} unique')
