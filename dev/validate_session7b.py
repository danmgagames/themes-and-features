"""
Session 7b validation gate.

Checks the 84 web-sourced classified JSONs in data/classified_7/ for:
...
5. base_key uniqueness within classified_7/
6. base_key non-collision with already-classified data/classified/
   (intentional — Session 7b targets ONLY base_keys not yet in classified/)
...
NEW_DIR = PROJECT_ROOT / 'data' / 'classified_7'
...
def main():
    failures: list[str] = []
    print('=' * 60)
    print('Session 7b — validation gate')
    print('=' * 60)
    ...
    print(f'\n[5] base_key uniqueness in classified_7/: {len(bks)} files, {len(set(bks))} unique')
